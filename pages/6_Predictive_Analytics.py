"""
Predictive Analytics & Forecasting Page
Time series forecasting and predictive modeling for Aadhaar data
"""
...
fig.add_annotation(
    x=time_series.index[-1],
    y=time_series.iloc[-1],
    text="Last observed value",
    showarrow=True
)
...
# Model evaluation (if enough data)
